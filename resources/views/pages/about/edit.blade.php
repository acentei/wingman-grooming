...
@section('content')
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">                   
                    <div class="col-sm-12">                         
                        <textarea id="about" name="about" rows="50" class="form-control" placeholder="Write your message..">{{$about->about_website}}</textarea>
                    </div>                   
                </div> 
                                
                <div>
                    <input id="button" type="submit" name="publish" value="Update" class="btn btn-success"/>
                    <a id="button" href="{{ route('about.index') }}" class="btn btn-danger">Cancel</a>               
                </div>              
    ...
    <script type="text/javascript">
        ...
        tinymce.init({ selector:'textarea#about',                           
                       theme: 'modern',
                       plugins: [
