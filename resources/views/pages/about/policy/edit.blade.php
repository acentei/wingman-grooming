...
@section('content')
    ...
    {!! Form::model($policy, [
	    'method' => 'PUT',
	    'route' => ['policy.update', $policy->about_id],
	]) !!}
    ...
    <div id="panel-style" class="panel panel-primary" style="width: 90%; margin: auto;">
        <div id="panel-style-header" class="panel-heading">
            <h3 class="panel-title"><b>Edit About the Website</b></h3>
        </div>
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">                   
                    <div class="col-sm-12">                         
                        <textarea id="policy" name="policy" rows="50" class="form-control" placeholder="Write your message..">{{$policy->policy}}</textarea>
                    </div>                   
                </div> 
                                
                <div>
                    <input id="button" type="submit" name="publish" value="Update" class="btn btn-success"/>                    
                    <a id="btnCancel" data-href="{{ route('policy.index') }}" class="btn btn-danger"
    ...
    <script type="text/javascript">
        ...
        tinymce.init({ selector:'textarea#policy',                           
                       theme: 'modern',
                       plugins: [
