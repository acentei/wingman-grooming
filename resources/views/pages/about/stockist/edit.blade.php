...
@section('content')
    ...
    {!! Form::model($stockist, [
	    'method' => 'PUT',
	    'route' => ['stockist.update', $stockist->about_id],
	]) !!}
    ...
    <div id="panel-style" class="panel panel-primary" style="width: 90%; margin: auto;">
        <div id="panel-style-header" class="panel-heading">
            <h3 class="panel-title"><b>Edit Stockists</b></h3>
        </div>
        ...
        <div class="panel-body">
            <div class="form-horizontal">
                ...
                <div class="form-group">                   
                    <div class="col-sm-12">                         
                        <textarea id="stockist" name="stockist" rows="50" class="form-control" placeholder="Write your message..">{{$stockist->stockist}}</textarea>
                    </div>                   
                </div> 
                                
                <div>
                    <input id="button" type="submit" name="publish" value="Update" class="btn btn-success"/>
                    <a id="btnCancel" data-href="{{ route('stockist.index') }}" class="btn btn-danger"
                        class = "btn btn-danger" data-toggle = "modal" data-target = "#confirmCancel"
                        data-title = "Cancel editing Stockist?" data-message = "Your changes will not be saved. Are you sure?"
    ...
    <script type="text/javascript">
        ...
        tinymce.init({ selector:'textarea#stockist',                           
                       theme: 'modern',
                       plugins: [
